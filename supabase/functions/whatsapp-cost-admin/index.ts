    ...
    if (action === "simulate") {
      ...
      return jsonResponse({
        ...
        result: simulateCost({
          cfg,
          card: card ?? null,
          inbound: Number(body.inbound || 0),
          outbound: Number(body.outbound || 0),
          failed: Number(body.failed || 0),
          templateCategory: body.template_category ?? null,
          templates: Number(body.templates || 0),
          ...
          thinkingTokens: Number(body.thinking_tokens || 0),
          cachedInputTokens: Number(body.cached_input_tokens || 0),
          voiceMinutes: Number(body.voice_minutes || 0),
          fxOverride: body.fx_override == null ? null : Number(body.fx_override),
        }),
      });
    }
