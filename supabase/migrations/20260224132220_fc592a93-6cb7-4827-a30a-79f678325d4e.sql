...
BEGIN
  IF NEW.rider_id IS NOT NULL 
    ...
    IF v_delivery_company_id IS NOT NULL THEN
      -- Delivery company rider: use company commission rate
    ...
    ELSE
      -- Platform or vendor-affiliated rider
