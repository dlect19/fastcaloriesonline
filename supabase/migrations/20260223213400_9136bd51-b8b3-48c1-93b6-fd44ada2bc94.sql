...
-- Update the credit_vendor_on_payment trigger to record service_fee_amount in order_financials
-- and use resolve_commission_rate for dynamic commission resolution
...
BEGIN
  IF NEW.payment_status = 'paid' AND (OLD.payment_status IS NULL OR OLD.payment_status != 'paid') THEN
    ...
    -- Use resolve_commission_rate for dynamic vendor commission
    ...
    -- Initialize rider/logistics commission tracking
    ...
    IF NEW.rider_id IS NOT NULL AND v_delivery_fee > 0 THEN
      ...
      IF v_existing_rider_tx IS NULL THEN
        ...
        IF v_delivery_company_id IS NOT NULL THEN
          -- Use resolve_commission_rate for logistics company
        ...
        ELSE
          -- Platform rider: use resolve_commission_rate for rider
