      ...
      <DialogContent className="sm:max-w-md">
        ...
        {step === 'phone-code' && (
          <div className="space-y-4">
            ...
            <Button onClick={handleVerifyPhone} disabled={verifying} className="w-full h-12">
              {verifying ? <Loader2 className="w-5 h-5 animate-spin" /> : (mode === 'signup' ? 'Next: verify email' : 'Sign in')}
            </Button>
            <div className="flex items-center justify-between text-sm">
              <button type="button" className="text-muted-foreground hover:underline" onClick={() => setStep('phone')}>← Change number</button>
              <button type="button" className="text-primary hover:underline" onClick={handleSendPhone} disabled={sending}>
        ...
        {step === 'email' && (
          <div className="space-y-4">
            ...
            <button type="button" className="text-sm text-muted-foreground hover:underline" onClick={() => setStep('phone-code')}>
              ← Back
            </button>
          </div>
        )}
        ...
        {step === 'email-code' && (
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <button type="button" className="text-muted-foreground hover:underline" onClick={() => setStep('email')}>← Change email</button>
              <button type="button" className="text-primary hover:underline" onClick={handleSendEmail} disabled={sendingEmail}>
