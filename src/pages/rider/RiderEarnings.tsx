    ...
    <div className="min-h-screen bg-background flex">
      ...
      <main className="flex-1 p-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Track your income and withdrawals</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">₦{(wallet?.total_earned || 0).toLocaleString()}</div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">₦{(wallet?.total_withdrawn || 0).toLocaleString()}</div>
            </CardContent>
          </Card>
        </div>
              ...
              <div className="space-y-4">
                {transactions.map((txn) => (
                  <div key={txn.id} className="flex items-center justify-between py-3 border-b last:border-0">
                    ...
                    <p className={`font-bold ${txn.type === 'credit' ? 'text-calorie-low' : 'text-destructive'}`}>
